<template>
    <header class="header shadow-lg">
        <nav class="container center">
            ...
            <div class="tip">
                <img src="@/assets/提示.svg" @click="showTip">
                <img src="@/assets/添加.svg" v-if="isSearchRoute" @click="handlesave" :class="WeatherStore.checkdata(_adcode)?'fade-out':'opacity-1'">
            </div>
        </nav>
    </header>
</template>
